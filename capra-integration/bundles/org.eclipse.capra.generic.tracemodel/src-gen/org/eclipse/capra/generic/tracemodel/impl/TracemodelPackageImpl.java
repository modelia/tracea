...
import org.eclipse.capra.generic.tracemodel.DomainLink;
import org.eclipse.capra.generic.tracemodel.EngineeringLink;
...
public class TracemodelPackageImpl extends EPackageImpl implements TracemodelPackage {
	 ...
	 * @generated
	 */
	private EClass domainLinkEClass = null;
	 ...
	 * @generated
	 */
	private EClass engineeringLinkEClass = null;
	 ...
	 * @generated
	 */
	public EReference getRelatedTo_Confidence() {
	 ...
	 * @generated
	 */
	public EClass getDomainLink() {
		return domainLinkEClass;
	}
	 ...
	 * @generated
	 */
	public EClass getEngineeringLink() {
		return engineeringLinkEClass;
	}
	...
	public void createPackageContents() {
		...
		createEReference(relatedToEClass, RELATED_TO__CONFIDENCE);

		domainLinkEClass = createEClass(DOMAIN_LINK);

		engineeringLinkEClass = createEClass(ENGINEERING_LINK);
	...
	public void initializePackageContents() {
		...
		relatedToEClass.getESuperTypes().add(this.getTracingElement());
		domainLinkEClass.getESuperTypes().add(this.getRelatedTo());
		engineeringLinkEClass.getESuperTypes().add(this.getRelatedTo());
		...
		initEReference(getRelatedTo_Confidence(), this.getConfidence(), null, "confidence", null, 0, 1, RelatedTo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(domainLinkEClass, DomainLink.class, "DomainLink", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(engineeringLinkEClass, EngineeringLink.class, "EngineeringLink", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		...
		initEAttribute(getConfidence_Value(), theEcorePackage.getEDouble(), "value", null, 0, 1, Confidence.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
