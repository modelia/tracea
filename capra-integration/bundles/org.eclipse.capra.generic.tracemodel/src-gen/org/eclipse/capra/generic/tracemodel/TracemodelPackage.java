...
public interface TracemodelPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int RELATED_TO__ID = TRACING_ELEMENT__ID;
	 ...
	 * @ordered
	 */
	int RELATED_TO__TIMESTAMP = TRACING_ELEMENT__TIMESTAMP;
	 ...
	 * @ordered
	 */
	int RELATED_TO__AGENTS = TRACING_ELEMENT__AGENTS;
	 ...
	 * @ordered
	 */
	int RELATED_TO__NAME = TRACING_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RELATED_TO__ORIGIN = TRACING_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RELATED_TO__TARGETS = TRACING_ELEMENT_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int RELATED_TO__CONFIDENCE = TRACING_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int RELATED_TO_FEATURE_COUNT = TRACING_ELEMENT_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int RELATED_TO_OPERATION_COUNT = TRACING_ELEMENT_OPERATION_COUNT + 0;

	/**
	 * The meta object id for the '{@link org.eclipse.capra.generic.tracemodel.impl.DomainLinkImpl <em>Domain Link</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.eclipse.capra.generic.tracemodel.impl.DomainLinkImpl
	 * @see org.eclipse.capra.generic.tracemodel.impl.TracemodelPackageImpl#getDomainLink()
	 * @generated
	 */
	int DOMAIN_LINK = 3;
	 ...
	 * @ordered
	 */
	int DOMAIN_LINK__ID = RELATED_TO__ID;
	 ...
	 * @ordered
	 */
	int DOMAIN_LINK__TIMESTAMP = RELATED_TO__TIMESTAMP;
	 ...
	 * @ordered
	 */
	int DOMAIN_LINK__AGENTS = RELATED_TO__AGENTS;
	 ...
	 * @ordered
	 */
	int DOMAIN_LINK__NAME = RELATED_TO__NAME;
	 ...
	 * @ordered
	 */
	int DOMAIN_LINK__ORIGIN = RELATED_TO__ORIGIN;
	 ...
	 * @ordered
	 */
	int DOMAIN_LINK__TARGETS = RELATED_TO__TARGETS;
	 ...
	 * @ordered
	 */
	int DOMAIN_LINK__CONFIDENCE = RELATED_TO__CONFIDENCE;
	 ...
	 * @ordered
	 */
	int DOMAIN_LINK_FEATURE_COUNT = RELATED_TO_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int DOMAIN_LINK_OPERATION_COUNT = RELATED_TO_OPERATION_COUNT + 0;

	/**
	 * The meta object id for the '{@link org.eclipse.capra.generic.tracemodel.impl.EngineeringLinkImpl <em>Engineering Link</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.eclipse.capra.generic.tracemodel.impl.EngineeringLinkImpl
	 * @see org.eclipse.capra.generic.tracemodel.impl.TracemodelPackageImpl#getEngineeringLink()
	 * @generated
	 */
	int ENGINEERING_LINK = 4;
	 ...
	 * @ordered
	 */
	int ENGINEERING_LINK__ID = RELATED_TO__ID;
	 ...
	 * @ordered
	 */
	int ENGINEERING_LINK__TIMESTAMP = RELATED_TO__TIMESTAMP;
	 ...
	 * @ordered
	 */
	int ENGINEERING_LINK__AGENTS = RELATED_TO__AGENTS;
	 ...
	 * @ordered
	 */
	int ENGINEERING_LINK__NAME = RELATED_TO__NAME;
	 ...
	 * @ordered
	 */
	int ENGINEERING_LINK__ORIGIN = RELATED_TO__ORIGIN;
	 ...
	 * @ordered
	 */
	int ENGINEERING_LINK__TARGETS = RELATED_TO__TARGETS;
	 ...
	 * @ordered
	 */
	int ENGINEERING_LINK__CONFIDENCE = RELATED_TO__CONFIDENCE;

	/**
	 * The number of structural features of the '<em>Engineering Link</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ENGINEERING_LINK_FEATURE_COUNT = RELATED_TO_FEATURE_COUNT + 0;

	/**
	 * The number of operations of the '<em>Engineering Link</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ENGINEERING_LINK_OPERATION_COUNT = RELATED_TO_OPERATION_COUNT + 0;
	...
	/**
	 * Returns the meta object for the containment reference '{@link org.eclipse.capra.generic.tracemodel.RelatedTo#getConfidence <em>Confidence</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Confidence</em>'.
	 * @see org.eclipse.capra.generic.tracemodel.RelatedTo#getConfidence()
	 * @see #getRelatedTo()
	 * @generated
	 */
	EReference getRelatedTo_Confidence();

	/**
	 * Returns the meta object for class '{@link org.eclipse.capra.generic.tracemodel.DomainLink <em>Domain Link</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	EClass getDomainLink();

	/**
	 * Returns the meta object for class '{@link org.eclipse.capra.generic.tracemodel.EngineeringLink <em>Engineering Link</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Engineering Link</em>'.
	 * @see org.eclipse.capra.generic.tracemodel.EngineeringLink
	 * @generated
	 */
	EClass getEngineeringLink();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference RELATED_TO__CONFIDENCE = eINSTANCE.getRelatedTo_Confidence();

		/**
		 * The meta object literal for the '{@link org.eclipse.capra.generic.tracemodel.impl.DomainLinkImpl <em>Domain Link</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.eclipse.capra.generic.tracemodel.impl.DomainLinkImpl
		 * @see org.eclipse.capra.generic.tracemodel.impl.TracemodelPackageImpl#getDomainLink()
		 * @generated
		 */
		EClass DOMAIN_LINK = eINSTANCE.getDomainLink();

		/**
		 * The meta object literal for the '{@link org.eclipse.capra.generic.tracemodel.impl.EngineeringLinkImpl <em>Engineering Link</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.eclipse.capra.generic.tracemodel.impl.EngineeringLinkImpl
		 * @see org.eclipse.capra.generic.tracemodel.impl.TracemodelPackageImpl#getEngineeringLink()
		 * @generated
		 */
		EClass ENGINEERING_LINK = eINSTANCE.getEngineeringLink();
