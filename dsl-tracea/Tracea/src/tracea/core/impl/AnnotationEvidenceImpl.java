 ...
 * </p>
 * <ul>
 *   <li>{@link tracea.core.impl.AnnotationEvidenceImpl#getContent <em>Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnotationEvidenceImpl extends EvidenceImpl implements AnnotationEvidence {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.ANNOTATION_EVIDENCE;
	}
	...
	public void setContent(String newContent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ANNOTATION_EVIDENCE__CONTENT, oldContent, content));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CorePackage.ANNOTATION_EVIDENCE__CONTENT:
				return getContent();
		}
